            ...
            <main className="main">
                <section className="main-aboutus">
                    ...
                    <div className="container-buttons">
                        <button className="secondary-button financiera"><a href="./financiero.html">Financiero</a></button>
                        <button className="secondary-button laboral"><a href="./laboral.html">Laboral</a></button>
                        <button className="secondary-button emocional"><a href="./emocional.html">Emocional</a></button>
                    </div>
